...
const About = () => {
  ...
  const handleConfirmDownload = () => {
    ...
    toast.info('Resume downloading', { autoClose: 2000 });
  ...
  const handleCloseModal = () => {
    ...
    toast.warning('Resume not downloaded', { autoClose: 2000 });
  };
      ...
      <div className="about-section">
        <div className="left-column">
          ...
          <p className="career-highlight">
            ...
            always eager to keep up with the latest advancements in the field. My primary areas of expertise lie in React and JavaScript,
